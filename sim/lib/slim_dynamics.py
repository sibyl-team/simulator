...
class DiseaseModel(object):
    ...
    def init_all(self, params, initial_counts,thresholds_roc=[], verbose=True):
        """
    ...
    def run_one_step_dyn(self, max_time, excluded):
        ...
        while self.queue:
            ...
            if event == 'expo':
                ...
                if (infector is None) and i_susceptible and not excluded[i]:
                ...
                if (infector is not None) and i_susceptible and k >= 0:
                    ...
                    #    or got hospitalized
                    infector_contained = excluded[infector] or self.state['hosp'][infector]
                    #self.is_person_home_from_visit_due_to_measure(
    ...
    def __process_presymptomatic_event(self, t, i, i_excluded, add_exposures=True):
        """
    ...
    def __process_asymptomatic_event(self, t, i,i_excluded, add_exposures=True):
        """
